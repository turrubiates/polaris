...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.acuerdosCep.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.acuerdos-ceps.update", [$acuerdosCep->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
