...
@section('content')
@can('acuerdos_cog_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.acuerdos-cogs.create") }}">
                {{ trans('global.add') }} {{ trans('cruds.acuerdosCog.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.acuerdosCog.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AcuerdosCog">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.acuerdosCog.fields.votos_a_favor') }}
                    </th>
                    <th>
                        {{ trans('cruds.acuerdosCog.fields.etiquetas') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@can('acuerdos_cog_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.acuerdos-cogs.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.acuerdos-cogs.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  $('.datatable-AcuerdosCog').DataTable(dtOverrideGlobals);
