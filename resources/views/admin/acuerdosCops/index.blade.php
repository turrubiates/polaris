...
@section('content')
@can('acuerdos_cop_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.acuerdos-cops.create") }}">
                {{ trans('global.add') }} {{ trans('cruds.acuerdosCop.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.acuerdosCop.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AcuerdosCop">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.acuerdosCop.fields.votos_a_favor') }}
                    </th>
                    <th>
                        {{ trans('cruds.acuerdosCop.fields.etiquetas') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@can('acuerdos_cop_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.acuerdos-cops.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.acuerdos-cops.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  $('.datatable-AcuerdosCop').DataTable(dtOverrideGlobals);
