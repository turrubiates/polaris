        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.avisosDeSalida.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.avisos-de-salidas.update", [$avisosDeSalida->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
