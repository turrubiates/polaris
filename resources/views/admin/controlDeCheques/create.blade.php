                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.control-de-cheques.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('numero_de_cheque') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="numero_de_cheque" name="numero_de_cheque" class="form-control" value="{{ old('numero_de_cheque', isset($controlDeCheque) ? $controlDeCheque->numero_de_cheque : '0') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nombre_a_quien_se_expide') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="nombre_a_quien_se_expide" name="nombre_a_quien_se_expide" class="form-control" value="{{ old('nombre_a_quien_se_expide', isset($controlDeCheque) ? $controlDeCheque->nombre_a_quien_se_expide : '0') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('descripcion') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="descripcion" name="descripcion" class="form-control" value="{{ old('descripcion', isset($controlDeCheque) ? $controlDeCheque->descripcion : '0') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nombre_a_quien_se_entrego') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="nombre_a_quien_se_entrego" name="nombre_a_quien_se_entrego" class="form-control" value="{{ old('nombre_a_quien_se_entrego', isset($controlDeCheque) ? $controlDeCheque->nombre_a_quien_se_entrego : '0') }}">
