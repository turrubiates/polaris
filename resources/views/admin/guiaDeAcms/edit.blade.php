...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.guiaDeAcm.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.guia-de-acms.update", [$guiaDeAcm->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
