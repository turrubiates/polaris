...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.listaDeEvento.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.lista-de-eventos.update", [$listaDeEvento->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('participantes') ? 'has-error' : '' }}">
                ...
                @foreach(App\ListaDeEvento::PARTICIPANTES_RADIO as $key => $label)
                    <div>
                        <input id="participantes_{{ $key }}" name="participantes" type="radio" value="{{ $key }}" {{ old('participantes', $listaDeEvento->participantes) === (string)$key ? 'checked' : '' }} required>
            ...
            <div class="form-group {{ $errors->has('participantes_ml') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_ml" name="participantes_ml" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_ml) || old('participantes_ml', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('participantes_ts') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_ts" name="participantes_ts" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_ts) || old('participantes_ts', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('participantes_cc') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_cc" name="participantes_cc" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_cc) || old('participantes_cc', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('participantes_cr') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_cr" name="participantes_cr" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_cr) || old('participantes_cr', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('participantes_sd') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_sd" name="participantes_sd" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_sd) || old('participantes_sd', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('participantes_ai') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="participantes_ai" name="participantes_ai" {{ (isset($listaDeEvento) && $listaDeEvento->participantes_ai) || old('participantes_ai', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group {{ $errors->has('costo') ? 'has-error' : '' }}">
                ...
                @foreach(App\ListaDeEvento::COSTO_RADIO as $key => $label)
                    <div>
                        <input id="costo_{{ $key }}" name="costo" type="radio" value="{{ $key }}" {{ old('costo', $listaDeEvento->costo) === (string)$key ? 'checked' : '' }} required>
            ...
            <div class="form-group {{ $errors->has('nivel') ? 'has-error' : '' }}">
                ...
                <select id="nivel" name="nivel" class="form-control" required>
                    ...
                    @foreach(App\ListaDeEvento::NIVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('nivel', $listaDeEvento->nivel) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('nivel'))
                    <p class="help-block">
            ...
            <div class="form-group {{ $errors->has('adultos_responsables') ? 'has-error' : '' }}">
                ...
                <select id="adultos_responsables" name="adultos_responsables" class="form-control">
                    ...
                    @foreach(App\ListaDeEvento::ADULTOS_RESPONSABLES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('adultos_responsables', $listaDeEvento->adultos_responsables) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group {{ $errors->has('staff') ? 'has-error' : '' }}">
                ...
                <select id="staff" name="staff" class="form-control">
                    ...
                    @foreach(App\ListaDeEvento::STAFF_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('staff', $listaDeEvento->staff) === (string)$key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('staff'))
                    <p class="help-block">
