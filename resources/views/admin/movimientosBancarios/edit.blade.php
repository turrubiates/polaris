        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.movimientosBancario.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.movimientos-bancarios.update", [$movimientosBancario->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
