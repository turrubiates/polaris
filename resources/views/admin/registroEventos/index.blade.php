...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-RegistroEvento">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.registroEvento.fields.participantes') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.registro-eventos.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'evento_nombre_de_evento', name: 'evento.nombre_de_evento' },
{ data: 'grupo_grupo', name: 'grupo.grupo' },
{ data: 'participantes', name: 'participantes.cum' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
    ],
    order: [[ 1, 'desc' ]],
    pageLength: 25,
  };
  $('.datatable-RegistroEvento').DataTable(dtOverrideGlobals);
