                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('cum') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="cum" name="cum" class="form-control" value="{{ old('cum', isset($user) ? $user->cum : '0') }}">
                            @if($errors->has('cum'))
                                <p class="help-block">
                                    {{ $errors->first('cum') }}
                                </p>
                        ...
                        <div class="form-group {{ $errors->has('curp') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="curp" name="curp" class="form-control" value="{{ old('curp', isset($user) ? $user->curp : '0') }}">
                            @if($errors->has('curp'))
                                <p class="help-block">
                                    {{ $errors->first('curp') }}
                                </p>
                        ...
                        <div class="form-group {{ $errors->has('nombre') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" value="{{ old('nombre', isset($user) ? $user->nombre : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('apellido_paterno') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="apellido_paterno" name="apellido_paterno" class="form-control" value="{{ old('apellido_paterno', isset($user) ? $user->apellido_paterno : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('apellido_materno') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="apellido_materno" name="apellido_materno" class="form-control" value="{{ old('apellido_materno', isset($user) ? $user->apellido_materno : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('sexo') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="sexo" name="sexo" class="form-control" value="{{ old('sexo', isset($user) ? $user->sexo : '0') }}">
                            @if($errors->has('sexo'))
                                <p class="help-block">
                                    {{ $errors->first('sexo') }}
                                </p>
                        ...
                        <div class="form-group {{ $errors->has('ocupacion') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="ocupacion" name="ocupacion" class="form-control" value="{{ old('ocupacion', isset($user) ? $user->ocupacion : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('telefono_particular') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="telefono_particular" name="telefono_particular" class="form-control" value="{{ old('telefono_particular', isset($user) ? $user->telefono_particular : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('telefono_oficina') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="telefono_oficina" name="telefono_oficina" class="form-control" value="{{ old('telefono_oficina', isset($user) ? $user->telefono_oficina : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('domicilio') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="domicilio" name="domicilio" class="form-control" value="{{ old('domicilio', isset($user) ? $user->domicilio : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('colonia') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="colonia" name="colonia" class="form-control" value="{{ old('colonia', isset($user) ? $user->colonia : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('municipio') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="municipio" name="municipio" class="form-control" value="{{ old('municipio', isset($user) ? $user->municipio : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('estado') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="estado" name="estado" class="form-control" value="{{ old('estado', isset($user) ? $user->estado : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('provincia') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="provincia" name="provincia" class="form-control" value="{{ old('provincia', isset($user) ? $user->provincia : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('distrito') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="distrito" name="distrito" class="form-control" value="{{ old('distrito', isset($user) ? $user->distrito : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('grupo') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="grupo" name="grupo" class="form-control" value="{{ old('grupo', isset($user) ? $user->grupo : '0') }}">
                            @if($errors->has('grupo'))
                                <p class="help-block">
                                    {{ $errors->first('grupo') }}
                                </p>
                        ...
                        <div class="form-group {{ $errors->has('localidad') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="localidad" name="localidad" class="form-control" value="{{ old('localidad', isset($user) ? $user->localidad : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('seccion') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="seccion" name="seccion" class="form-control" value="{{ old('seccion', isset($user) ? $user->seccion : '0') }}">
                        ...
                        <div class="form-group {{ $errors->has('religion') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="religion" name="religion" class="form-control" value="{{ old('religion', isset($user) ? $user->religion : '0') }}">
