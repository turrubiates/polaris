    ...
    <div class="card-body">
        <form action="{{ route("admin.users.update", [$user->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('cum') ? 'has-error' : '' }}">
                ...
                <input type="text" id="cum" name="cum" class="form-control" value="{{ old('cum', isset($user) ? $user->cum : '') }}" required>
                @if($errors->has('cum'))
                    <p class="help-block">
                        {{ $errors->first('cum') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('cargo') ? 'has-error' : '' }}">
                <label for="cargo">{{ trans('cruds.user.fields.cargo') }}</label>
                <input type="text" id="cargo" name="cargo" class="form-control" value="{{ old('cargo', isset($user) ? $user->cargo : '') }}">
                @if($errors->has('cargo'))
                    <p class="help-block">
                        {{ $errors->first('cargo') }}
                    </p>
                @endif
                <p class="helper-block">
                    {{ trans('cruds.user.fields.cargo_helper') }}
                </p>
            </div>
            <div>
